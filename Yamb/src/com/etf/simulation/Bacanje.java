...
public class Bacanje
{
	...
	{
		return "Bacanje [brojPartije=" + brojPartije + ", igrac=" + igrac + ", bacanje1=" + bacanje1 + ", bacanje2=" + bacanje2 + ", bacanje3=" + bacanje3 + ", x=" + x + ", y="
				+ y + ", value=" + value + ", selected1=" + selected1 + ", selected2=" + selected2 + "]";
	}
