            ...
            case WAIT_USER :
                ...
                switch (brojBacanja)
                {
                    ...
                    case 2 : // nakon poteza 2 ;
                        ...
                        lista2.get(lista2.size() - 1).setBacanje2(values2); // uneto bacanje 2
                        boolean[] tempSelected2 = Controler.getControler().getBoard().getDices().getSelected();
                    ...
                    case 3 :
                        ...
                        lista3.get(lista3.size() - 1).setBacanje3(values3); // uneto bacanje 2
                        boolean[] tempSelected3 = Controler.getControler().getBoard().getDices().getSelected();
                        ...
                        lista3.get(lista3.size() - 1).setSelected1(selectedString3);
