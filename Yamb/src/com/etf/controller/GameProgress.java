...
//Klasa zadužena za stanja igrice
public class GameProgress
{
    ...
    protected Void doInBackground()
    {
        ...
        switch (stanje)
        {
            case POCETNO_STANJE : // ovo je stanje pre prvog muækanja
            ...
            case WAIT_USER : // u ovom stanju èeka se da korisnik unese rezultat u polje ili da promuæka kockice
    ...
    /**
     * Samo izvrši doInBackground metodu
     */
    public void execute()
    {
        doInBackground();
