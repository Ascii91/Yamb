...
public class YambDb
{
    ...
    private static final String DATABASE_CREATE_IGRA_TABLE    =
                                                              ...
                                                              "create table igra (rb integer primary key autoincrement, " + "pl1 text null," + "pl2 text null,"
                                                                      + "pl3 text  null," + "pl4 text  null," + "vreme long  null," + "trajanje long  null,"
                                                                      + "broj_igraca integer null," + "winner_name text null," + "winner_score integer null )";

    private static final String DATABASE_CREATE_BACANJE_TABLE = "create table bacanje (id integer primary key autoincrement, " + "rb integer not null,"
                                                                      + "igrac text not null," + "bacanje1 text  null," + "bacanje2 text  null,"
                                                                      + "bacanje3 text  null," + "x integer  null," + "y integer  null,"
                                                                      + "value integer  null," + "selected1 text  null," + "selected2 text  null)";
    ...
    public List<Igra> getIgre()
    {
        ...
        String[] COLUMNS = {"pl1", "pl2", "pl3", "pl4", "vreme", "rb", "broj_igraca", "winner_name", "winner_score"};
        open();
        ...
        if (cursor.moveToFirst())
        {
            do
            {
                ...
                igra.setWinnerName(cursor.getString(7));
                igra.setWinnerScore(cursor.getInt(8));
    ...
    public void insertIgra()
    {
        ...
        cv.put("winner_name", igra.getWinnerName());
        cv.put("winner_score", igra.getWinnerScore());
